...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ros2_user/ros2_ws/src/sailboat_sensors/sailboat_sensors', '..')))


# -- Project information -----------------------------------------------------

project = 'sailboat_sensors'
# TODO(tfoote) The docs say year and author but we have this and it seems more relevant.
copyright = 'The <sailboat_sensors> Contributors. License: Apache License 2.0'
author = """alber"""
