...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ros2_user/ros2_ws/src/sailboat_launch/sailboat_launch', '..')))
...
copyright = 'The <sailboat_launch> Contributors. License: Apache License 2.0'
author = """alber"""
