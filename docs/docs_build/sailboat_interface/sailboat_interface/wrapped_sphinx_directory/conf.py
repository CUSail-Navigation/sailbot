...
exec(open("/home/ros2_user/ros2_ws/src/docs/docs_build/sailboat_interface/sailboat_interface/default_sphinx_project/conf.py").read())
...
ensure_global('project', "sailboat_interface")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rosidl_default_runtime', 'std_msgs']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/ros2_user/ros2_ws/src/docs/docs_build/sailboat_interface/sailboat_interface/wrapped_sphinx_directory/generated",
