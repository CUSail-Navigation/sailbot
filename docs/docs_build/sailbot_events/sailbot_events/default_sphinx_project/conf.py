...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ros2_user/ros2_ws/src/sailbot_events/sailbot_events', '..')))


# -- Project information -----------------------------------------------------

project = 'sailbot_events'
# TODO(tfoote) The docs say year and author but we have this and it seems more relevant.
copyright = 'The <sailbot_events> Contributors. License: TODO: License declaration'
author = """root"""
