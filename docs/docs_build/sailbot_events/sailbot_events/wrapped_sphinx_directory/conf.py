...
exec(open("/home/ros2_user/ros2_ws/src/docs/docs_build/sailbot_events/sailbot_events/default_sphinx_project/conf.py").read())
...
ensure_global('project', "sailbot_events")
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/ros2_user/ros2_ws/src/docs/docs_build/sailbot_events/sailbot_events/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'sailboat_sensors': ('http://docs.ros.org/en/latest/p/sailboat_sensors/', '/home/ros2_user/ros2_ws/src/docs/cross_reference/sailboat_sensors/objects.inv'),
        ...
        'sailboat_main': ('http://docs.ros.org/en/latest/p/sailboat_main/', '/home/ros2_user/ros2_ws/src/docs/cross_reference/sailboat_main/objects.inv'),
        'sailboat_interface': ('http://docs.ros.org/en/latest/p/sailboat_interface/', '/home/ros2_user/ros2_ws/src/docs/cross_reference/sailboat_interface/objects.inv')
    })
