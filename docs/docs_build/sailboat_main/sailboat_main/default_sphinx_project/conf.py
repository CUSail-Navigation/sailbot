...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/ros2_user/ros2_ws/src/sailboat_main/sailboat_main', '..')))


# -- Project information -----------------------------------------------------

project = 'sailboat_main'
# TODO(tfoote) The docs say year and author but we have this and it seems more relevant.
copyright = 'The <sailboat_main> Contributors. License: TODO: License declaration'
author = """alber"""
