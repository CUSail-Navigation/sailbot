...
class Teensy(Node):
    ...
    def __init__(self):
        ...
        # Teensy TX ~0.5 s; poll at rx_period (default 0.5 s) so reads keep up with telemetry.
        ...
        # keep track of our desired sail, rudder, and jib
        self.desired_sail = 0
    ...
    def _send_command_to_teensy(self):
        """Send the latest sail, rudder, and jib goals in one serial packet."""
    ...
    def jib_side_flag_callback(self, msg):
        """Handle ``jib_side_flag`` (UInt8: port vs starboard active sheet)."""
