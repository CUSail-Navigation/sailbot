...
class TeensyHardware:
    ...
    # [wind_hi, wind_lo, sail_angle, rudder_angle, jib_angle, dropped_packets]
    PACKET_LENGTH = 6
    ...
    def _parse_packet(self, packet):
        ...
        return wind_angle, sail_angle, rudder_angle, jib_angle, dropped_packets
    ...
    def send_command(self, sail, rudder, jib=0):
        ...
        try:
            ...
            # [sail_angle, rudder_angle, jib_angle]
