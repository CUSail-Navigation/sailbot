...
class Algo(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('tacking_buffer', 10)
        ...
        self.turn_left = True # 0 for right, 1 for left
    ...
    def update_state(self):
        ...
        if self.sail_state == SailState.NORMAL:
            ...
            if self.waypoint_in_nogo_zone() and self.tack_time_tracker > self.tacking_buffer:
    ...
    def set_tacking_rudder(self): 
        ...
        if self.turn_left:
            rudder_angle = -self.MAX_RUDDER_ANGLE
        else:
            # tack on right
            rudder_angle = self.MAX_RUDDER_ANGLE
