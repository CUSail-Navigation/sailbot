...
namespace constants {
    ...
    namespace servo {
        ...
        constexpr uint32_t JIB_PORT_MIN_PULSE = 750;                                                                    //TODO
        constexpr uint32_t JIB_PORT_MAX_PULSE = 1750;                                                                   //TODO

        constexpr uint32_t JIB_STB_MIN_PULSE = 850;                                                                     //TODO
        constexpr uint32_t JIB_STB_MAX_PULSE = 2200;                                                                    //TODO
