...
namespace constants {
    ...
    namespace servo {
        ...
        // (2025-2026) Rudder servo pulse widths (µs) for attach(), mapping, and writes. This is the
        // range that corresponds to full rudder travel on our hull linkage—not the generic 600-2400 
        // span for the servo class.
